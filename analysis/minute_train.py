...
if __name__ == '__main__':
    ...
    parser.add_argument('--tgt_amplifier', type=float, default=1)
    parser.add_argument('--tgt_clip_value', type=float, default=0.1)
    parser.add_argument('--value_threshold', type=float, default=0.05)
    parser.add_argument('--strong_threshold', type=float, default=0.09)
