...
def main(args):
    ...
    for file in tqdm(files):
        ...
        for idx in tqdm(range(0, minute.shape[0]-args.data_len-args.pred_len, args.data_hop)):
            ...
            data.append({'ob':ob_minute[idx:idx+args.data_len].transpose(1,0,2).tolist(),
                         'tr':tr_minute[idx:idx+args.data_len].transpose(1,0,2).tolist(),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/home/jay/UpbitTrade/analysis/data/combined/minute')
    parser.add_argument('--save_dir', type=str, default='/home/jay/UpbitTrade/analysis/data/train/minute')
